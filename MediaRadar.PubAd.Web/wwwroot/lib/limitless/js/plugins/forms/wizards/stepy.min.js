    ...
    var methods = {
        init: function (settings) {
            ...
            if (self.finish.length) {
                ...
                if (self.opt.stepAddtionalCssClass && self.opt.stepAddtionalCssClass != "") {
                    self.steps.last().children('.stepy-navigator').removeClass(self.opt.stepAddtionalCssClass);
                }
            } else {
            ...
            var self = this,
                that = $(this),
                attributes = { href: '#', 'class': 'button-back btn btn-default', html: self.opt.backLabel };
            ...
            var self = this,
                that = $(this);
            var attributes = {};
            if (self.opt.disabledByDefault) {
                attributes = { href: '#', 'disabled': true, 'class': 'button-next btn btn-default', html: self.opt.nextLabel };
            }
            else {
                attributes = { href: '#', 'class': 'button-next btn btn-default', html: self.opt.nextLabel };
            }
            ...
            var header = $('<ul />', { id: $(this).attr('id') + '-header', 'class': 'stepy-header hidden-xs' });
            ...
            return $('<div class="stepy-navigator ' + this.opt.stepAddtionalCssClass + '" />');
